  ...
  def create
    ...
    respond_to do |format|
      if @grocery_list.save
        format.html { redirect_to(@grocery_list, :notice => 'GroceryList was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @grocery_list.update_attributes(params[:grocery_list])
        format.html { redirect_to(@grocery_list, :notice => 'GroceryList was successfully updated.') }
        format.xml  { head :ok }
      else
